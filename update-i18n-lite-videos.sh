...
jenkins-tools/build.lib safe_pull_in_branch . translations
# ...which we want to make sure is up-to-date with master.
jenkins-tools/build.lib safe_merge_from_master . translations
# We also make sure the intl/translations sub-repo is up to date.
jenkins-tools/build.lib safe_pull intl/translations
