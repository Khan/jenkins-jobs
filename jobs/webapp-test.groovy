...
TESTS = [
    ...
    [cmd: "testing/runlint.sh -j 1 --server=<server> javascript", done: false],
    [cmd: "testing/runlint.sh -j 1 --server=<server> python", done: false],
    [cmd: "testing/runlint.sh -j 1 --server=<server> go", oneAtATime: true, done: false],
    [cmd: "testing/runlint.sh -j 1 --server=<server> kotlin", done: false],
    [cmd: "testing/runlint.sh -j 1 --server=<server> other", done: false],
